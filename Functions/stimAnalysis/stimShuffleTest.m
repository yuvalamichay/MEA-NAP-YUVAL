...
%       .shuffleBinWidth       – (optional) bin width in seconds for the
%                                shuffle PSTH histogram.  Default: 0.002 (2 ms).
%                                This is independent of Params.rasterBinWidth.
%       .Nshuffles             – (optional) number of circular-shift shuffles.
%                                Default: 500
%       .shuffleAlpha          – (optional) significance level for the 
%                                two-tailed test.  Default: 0.05
% Info : struct
%     Must contain:
